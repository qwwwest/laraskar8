...
class Infini
{
     ...
     * @return array
     */
    public function parseString($str, &$externals = [], $pseudofilename = false): array
    {
        $ini = &$this->parsed;
    ...
    public function __invoke()
    {
        ...
        if (count($args) === 2 || count($args) === 3) {
            ...
            return $this->setVar($args[0], $this->parsed, $args[1], false);
        }
        // if (count($args) === 3) {
        //     //third argument force reset first.
        //     // if(is_array( $args[1]) )$this->setVar($args[0], $this->parsed, null, 0); 
        //      return $this->setVar($args[0], $this->parsed, $args[1], $args[2]);
        //  }
    }
     ...
     * @return mixed
     */
    private function setVar($varname, &$ini, $value, $reset = false)
    {
        ...
        foreach ($vars as $ii => $var) {
            ...
            // if ($ii === $last && $reset && isset($value[0]) ) {
            //     return $ini[$var] = $value;
            // }
            ...
            if (
                ...
                $merged = $this->array_merge_recursive_distinct($ini[$var], $value, $reset);
                $ini[$var] = $merged;
                return $merged;
            }
